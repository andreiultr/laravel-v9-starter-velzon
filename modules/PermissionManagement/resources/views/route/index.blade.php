      ...
      <tr>
        ...
        <td>
          <div class="dropdown">
            ...
            @include('permissionmanagement::components.form.modal.route.edit')
            @include('permissionmanagement::components.form.modal.route.delete')
          </div>
        </td>
      </tr>
      @empty
...
@include('permissionmanagement::components.form.modal.route.add')
@endsection