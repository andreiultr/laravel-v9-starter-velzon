      ...
      <tr>
        ...
        <td>
          <div class="dropdown">
            ...
            @include('permissionmanagement::components.form.modal.role.edit')
            @include('permissionmanagement::components.form.modal.role.delete')
          </div>
        </td>
      </tr>
      @empty
...
@include('permissionmanagement::components.form.modal.role.add')
@endsection