      ...
      <tr>
        ...
        <td>
          <div class="dropdown">
            ...
            @include('permissionmanagement::components.form.modal.permission.edit')
            @include('permissionmanagement::components.form.modal.permission.delete')
          </div>
        </td>
      </tr>
      @empty
...
@include('permissionmanagement::components.form.modal.permission.add')
@endsection