        ...
        <div class="modal-content">
            <form action="{{ route('menu.item.update', [$menu->id, $menuItem->id]) }}" method="post">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-form-edit-menu-{{ $menuItem->id }}-label">Edit Menu Item</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            ...
                            <input class="form-check-input code-switcher" type="checkbox" id="tables-small-showcode" name="status" @checked($menuItem->status)>
                        </div>
